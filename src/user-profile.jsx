                    ...
                    <ul class="space-y-2 font-medium">
                        <li>
                            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg text-wedvita-text-light-purple hover:bg-gray-100 hover:text-black group">
                                <svg class="w-5 h-5 transition duration-75 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                        ...
                        <div class="bg-white p-4 mb-4 rounded shadow">
                            <div class="mb-4">
                                <div class="border-b mb-2 pb-2">
                                    <div class="text-xl font-bold">Informasi Pengguna</div>
                                </div>
                                <div class="mb-2">
                                ...
                                <div class="mb-2">
                                    <div class="font-bold">Informasi Kontak</div>
                                    <div class="font-bold">Email</div>
                                    <div class="border bg-gray-100 p-2">
                                        <div class="mb-2">
                                            <div class="text-gray-700">test@email.com</div>
                                        </div>
                                    </div>
                                    <div class="mb-2">
                                    </div>
                                    <div class="mb-2">
                                        ...
                                        <button class="bg-blue-500 text-white px-4 py-2 rounded">Reset Password</button>
                                    </div>
                                </div>
                            </div>
                        </div>
